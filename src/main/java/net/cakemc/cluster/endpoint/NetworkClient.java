...
import net.cakemc.cluster.endpoint.codec.CompressionCodec;
import net.cakemc.cluster.endpoint.codec.PacketCodec;
import net.cakemc.cluster.handler.BossHandler;
 ...
 *
 * <p>The {@code NetworkClient} class extends {@code NetworkPoint} to implement
 * client-specific behavior for establishing connections, sending packets, and
 * handling reconnections in case of failures.</p>
 *
 * @see NetworkPoint
 * @see RingPacket
 */
public class NetworkClient extends NetworkPoint {
	...
	/**
	 * Constructs a new {@code NetworkClient} with the specified cluster node and
	 * node information.
	 *
	 ...
	 */
	public NetworkClient(AbstractNode clusterNode, NodeInformation nodeInformation) {
			...
			this.channelFuture = new Bootstrap()
				 ...
				 .handler(new ChannelInitializer<>() {
					 ...
					 protected void initChannel(Channel channel) throws Exception {
						 ...
						 channelPipeline.addAfter(COMPRESSION_CODEC, PACKET_CODEC, new PacketCodec(clusterNode.getPacketRegistry()));
