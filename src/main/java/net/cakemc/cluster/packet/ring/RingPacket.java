package net.cakemc.cluster.packet.ring;

import io.netty.buffer.ByteBuf;
import net.cakemc.cluster.packet.Packet;

/**
 * The {@code RingPacket} class is an abstract representation of a packet that
 * is part of a ring network structure in a cluster. It extends the {@link Packet}
 ...
 */
public abstract class RingPacket extends Packet {
	...
	/**
	 * Constructs a new {@code RingPacket} with specified addresses and target node.
	 *
	 ...
	 */
	public RingPacket(long packetInstanceAddress, long nodeWriteAddress, int targetNode) {
	...
	/**
	 * Constructs a new {@code RingPacket} with default values.
	 */
	public RingPacket() {}
