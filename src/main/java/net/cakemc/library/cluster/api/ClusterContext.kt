 ...
 */
    ...
    var handlerMap: MutableMap<String, PublicationHandler>? = null

    // identification
    var members: Set<MemberIdentifier>? = null
    var ownAddress: MemberIdentifier? = null

    // config
    var publicationType: Class<out Publication>? = null
    var authentication: Authentication? = null
    var prioritised: ShortArray? = null
     ...
     */
    // snapshot
    var snapshot: ClusterSnapshot? = null

    // type
    var type: SynchronisationType? = null

    // internal usage
    private var identifiers: MutableList<NodeIdentifier>? = null
    private var clusterMembers: MutableList<ClusterMember>? = null

    var context: SyncContext? = null
    var clusterIdentificationContext: ClusterIdentificationContext? = null

    var registry: ClusterIdRegistry? = null
    var networkServer: NetworkServer? = null
    var handler: SyncNetworkHandler? = null
    var backUpEndpoint: AbstractBackUpEndpoint? = null

    var protocolBundle: SyncProtocolBundle? = null
        private set
    private var connectionHandler: AbstractConnectionHandler? = null
    ...
    fun createInternalCluster() {
        ...
        (identifiers as ArrayList<NodeIdentifier>).forEach(Consumer {
          nodeIdentifier: NodeIdentifier -> registry!!.add(nodeIdentifier.id.toShort()) })
